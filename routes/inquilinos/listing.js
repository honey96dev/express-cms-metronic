...
const indexProc = (req, res, next) => {
    ...
    res.render('inquilinos/listing/index', {
        ...
        styles: [
            ...
            'stylesheets/site/inquilinos/listing/index.css',
        ],
        scripts: [
            'javascripts/site/inquilinos/listing/index.js',
        ],
    })
};
...
const addGetProc = (req, res, next) => {
    ...
    const styles = [
        '//fonts.googleapis.com/css?family=Roboto:400,500&display=swap',
        'stylesheets/site/inquilinos/listing/add.css',
    ...
    const scripts = [
        ...
        'javascripts/site/inquilinos/listing/add.js',
    ];
    if (!!id) {
        ...
        dbConn.query(sql, null, (error, result, fields) => {
            ...
            res.render('inquilinos/listing/add', {
                userName: req.session.inquilinos.name,
