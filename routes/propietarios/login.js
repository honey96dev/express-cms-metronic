...
const loginProc = (req, res, next) => {
    ...
    if (method === 'POST') {
        ...
        dbConn.query(sql, null, (error, results, fields) => {
            ...
            sql = sprintfJs.sprintf("SELECT U.* FROM `%s` U WHERE BINARY U.email = '%s' AND BINARY U.password = '%s' and BINARY U.emailVerified='1' and U.site='Propietarios';", config.dbTblName.propietarios, email, hash);
