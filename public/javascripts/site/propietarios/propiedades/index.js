...
Propiedades.prototype.generateList = function(items) {
    ...
    for (let item of items) {
        ...
        if (!!item.picture) {
            ...
            card = '<div class="col-xl-3 col-lg-4 col-md-4 col-sm-6 col-xm-12" onclick="instance.editItem(' + item.id + ')"><div class="kt-portlet kt-portlet--height-fluid"><div class="kt-portlet__body my-card list-card-body"><div class="list-card-solid"><div class="list-card-waiting-verification-mark2">Waiting for verification</div><div class="list-card-name">' + item.name + '</div></div><div class="list-card-address">' + item.address + '</div><div class="list-card-property-sec row"><div class="col-4 list-card-property"><li class="fa fa-expand-arrows-alt"></li>' + item.surface + 'm2</div><div class="col-4 list-card-property"><li class="fa fa-bed"></li>' + item.rooms + 'rooms</div><div class="col-4 list-card-property"><li class="fa fa-bath"></li>' + item.baths + 'baths</div></div></div></div></div>';
        }
        html += card;
    }
